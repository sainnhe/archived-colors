" =============================================================================
" URL: https://github.com/sainnhe/vim-color-atlantis/
" Filename: autoload/lightline/colorscheme/atlantis.vim
" Author: Sainnhepark
...
let s:dark = [ '#2e3440', 0 ]
let s:darkgrey = [ '#434c5e', 0 ]
let s:grey = [ '#58647a', 0 ]
let s:light = [ '#c5d4dd', 0 ]
let s:green = [ '#a3be8c', 0 ]
let s:cyan = [ '#8dbf9d', 0 ]
let s:blue = [ '#95b8f2', 0 ]
let s:magenta = [ '#a999f0', 0 ]
let s:yellow = [ '#dfc185', 0 ]
let s:red = [ '#e1647d', 0 ]
"}}}
...
let s:normal_middle_bg = s:darkgrey
...
let s:insert_middle_bg = s:darkgrey
...
let s:inactive_middle_bg = s:darkgrey
"}}}
...
let g:lightline#colorscheme#atlantis#palette = lightline#colorscheme#flatten(s:p)
